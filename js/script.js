...
$(document).ready(function () {
    ...
    owl.owlCarousel({
        ...
        //     var active_id = owl.find('.owl-item.active').find('.card-pole').attr('id');
        //     var title;
    ...
    function startCarousel(event) {
        ...
        //get the index of the research card to know if there is tree or five card in th page
        var researchIndex = owl.find('#research').closest('.owl-item').index();
